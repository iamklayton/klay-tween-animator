...
This is a custom """"animation"""" system for Roblox that makes use of TweenService with a focus on "animations are data, animator decides what to do with that data, animation player decides when to tell the animator to do its job" archietchure. Using TweenService allows better flexibility and making animations naturally look smoother, it also allows you to better make procedural animations and/or additive animations if you know what you're doing.
